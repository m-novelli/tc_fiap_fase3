...
def main_example_run():
    ...
    # --- 2. Carregamento/Criação dos Dados Históricos ---
...
# Ponto de entrada do script: se este arquivo for executado diretamente (não importado como módulo),
# a função main_example_run() será chamada.
